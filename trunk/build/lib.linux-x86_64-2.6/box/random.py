...
class ArbitraryDistribution:
    ...
    def __init__(self,distr=None,xgrid=None):
        ...
        self.xgrid=nu.linspace(self.lim[0],self.lim[1],self.N)
        ...
        cum=nu.array(cum)/2*(self.lim[1]-self.lim[0])/self.N
        self.norm=cum[-1]
        cum=cum/self.norm
